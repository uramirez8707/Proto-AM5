...
!  num_strat_pts   number of grid points where instantaneous output will be saved to
!                  file strat.data.  num_strat_pts must be <= max_strat_pts.
!                  NOTE: this option is currently not supported.
!  strat_pts  num_strat_pts  pairs of grid indices, i.e., the global indices for i,j.
!             NOTE: this option is currently not supported.
!  debugo     should we activated debug diagnostics ?
!  debugo0    should we activated debug diagnostics  -- not fully implemented?
!  debugo4    if true, nrefuse is output
!  isamp  i coordinate of grid point for which debug data is to be written
!  jsamp  j coordinate of grid point for which debug data is to be written
!  ksamp  k coordinate of grid point for which debug data is to be written
