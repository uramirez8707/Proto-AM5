!FDOC_TAG_GFDL
module entrain_mod
! Contact Stephen.Klein@noaa.gov - Stephen Klein
...
real :: parcel_buoy =  0.25 ! scaling factor for surface parcel buoyancy
...
real :: radperturb  =  0.1  ! parcel perturbation looking for depth of
                            ! radiatively driven layer (K)
real :: critjump    =  0.1  ! critical jump for finding stable inter-
                            ! faces to bound convective layers, or to 
                            ! identify ambigous layers (K)
integer :: parcel_option = 2! Should the cloud top parcel property
...
!  layer:  calculate the depth of the the radiatively driven 
