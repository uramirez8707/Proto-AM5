...
!--- Radiation Flux block type
 ...
 type radiation_flux_block_type
     real, dimension(:,:,:), allocatable :: tdt_rad           , &
                                             tdt_lw            , &
                                             extinction        
     real, dimension(:,:),   allocatable :: flux_sw           , &
                                             flux_sw_dir            , &
                                             flux_sw_dif            , &
...
!--- Rad_flux type definition
 ...
 type radiation_flux_type
     ...
     type (radiation_flux_block_type), dimension(:), allocatable :: block 
...
type cloud_scheme_data_type
     ...
     real,  dimension(:,:,:), allocatable :: cloud_area     , & !  lsc, shallow
                                              liquid_amt     , & ! lsc, shallow
                                              ice_amt        , & !  lsc, shallow
                                              droplet_number , & ! lsc, shallow
                                              ice_number     , & ! lsc, shallow
                                              rain           , & ! lsc
                                              snow           , & ! lsc
                                              rain_size      , & ! lsc
                                              snow_size          ! lsc
...
!--- Moist Clouds block type
 ...
 type clouds_from_moist_block_type
     ...
     type(cloud_scheme_data_type), dimension(:), allocatable :: Cloud_data 
...
!--- Moist_clouds type definition
 ...
 type clouds_from_moist_type
    type (clouds_from_moist_block_type), dimension(:), allocatable :: block 
...
!--- Cosp Rad block type
 ...
 type cosp_from_rad_block_type
     real, dimension(:,:,:,:), allocatable :: tau_stoch        , &
                                               lwem_stoch       , &
                                               stoch_cloud_type , &
                                               stoch_conc_drop  , &
                                               stoch_conc_ice   , &
                                               stoch_size_drop  , &
                                               stoch_size_ice   
     real, dimension(:,:,:),   allocatable :: mr_ozone         
...
!--- Cosp_rad type definition
 ...
 type cosp_from_rad_type
     ...
     type (cosp_from_rad_block_type), dimension(:), allocatable :: block 
