...
! REVIEWER: Stuart.Freidenreich@noaa.gov - smf
...
logical      ::  do_herzberg = .false.          ! include the herzberg 
                                                ! effect on the o2 
                                                ! optical depth ?
logical      ::  do_quench = .true.             ! include the quenching
                                                ! effect of non-LTE 
...
logical      ::  do_n2o_sw_effects = .true.     ! the shortwave effects
                                                ! of n2o are included ?
logical      ::  do_sw_continuum =  .true.      ! include the shortwave
                                                ! continuum?
...
namelist / esfsw_driver_nml /    &
                               ...
                               do_sw_continuum, do_rayleigh, do_four_stream
