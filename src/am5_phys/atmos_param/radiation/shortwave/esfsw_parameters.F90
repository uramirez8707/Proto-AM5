...
!
! CONTACT EMAIL  Fei.Liu@noaa.gov - fil
! REVIEWER EMAIL Stuart.Freidenreich@noaa.gov - smf
...
character(len=16)  :: sw_code_version = 'esf2015' ! define version of code
                                            ! either esf1999 or esf2015
integer            :: sw_bands = 18         ! Number of shortwave
                                            ! bands only works if 
                                            ! sw_code_version = esf2015
integer            :: sw_int_points = 66    ! number of shortwave
