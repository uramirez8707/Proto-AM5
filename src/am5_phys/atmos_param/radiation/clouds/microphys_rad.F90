...
!
! This subroutine determines the infrared cloud emissivities for 
! specified wavenumber bands from parameterizations for 
! absorption coefficients due to cloud drops, cloud ice crystals, 
! rain and snow. conceptually one      
