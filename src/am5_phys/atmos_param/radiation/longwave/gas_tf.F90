...
!      co2lc the column of transmission functions
...
!      kcols  the starting column index number
!      kcole  the ending column index number
!      co2990c The column of transmission functions for 990-1070 cm-1 band
!      co2900c The column of transmission functions for 900-990 cm-1 band
!      
!      Gas_tf  The pre temperature-corrected co2 transmission functions
!
!  intent(out) variables:
...
!    press
!    pflux
!    to3cnt  o3, h2o continuum, halocarbon, aerosol transmission function for 990-1070 cm-1 band  
!
! intent(out) variables:
!
!    co2990nbl  CO2 transmission function for 990-1070 cm-1 band
!    co2900nbl  CO2 transmission function for 900-990 cm-1 band 
!    co21070nbl CO2 transmission function for 990-1070 cm-1 band
!
!--------------------------------------------------------------------
...
! intent(out) variables:
!
!    co2990c  CO2 transmission function for 990-1070 cm-1 band
!    co2990r  CO2 transmission function for 990-1070 cm-1 band
!    co2900c  CO2 transmission function for 900-990 cm-1 band
!    co2900r  CO2 transmission function for 900-990 cm-1 band
!    co21070c CO2 transmission function for 1070-1200 cm-1 band
!    co21070r CO2 transmission function for 1070-1200 cm-1 band
!
!--------------------------------------------------------------------
...
!--------------------------------------------------------------------
! Asign co2 transmission functions
!--------------------------------------------------------------------
integer,              intent(in)  :: nf
...
!
!     nf        index variable
!     co2m51_o  CO2 transmission function
!     cdtm51_o  CO2 transmission function
!     c2dm51_o  CO2 transmission function
!     co2m58_o  CO2 transmission function
!     cdtm58_o  CO2 transmission function
!     c2dm58_o  CO2 transmission function
!     co215nbsp1_o  CO2 transmission function
!     co215nbsp8_o  CO2 transmission function
!     co2dt15nbsp1_o  CO2 transmission function
!     co2dt15nbsp8_o  CO2 transmission function
!     co2d2t15nbps1_o CO2 transmission function
!     co2d2t15nbps8_o CO2 transmission function
!
!--------------------------------------------------------------------
...
!  intent(in) variables:
!
!    ch451_o CH4 transmission function
!
!-------------------------------------------------------------------
...
!    calc_n2o 
!
! logical variables that determine whether gas transmission function
...
!--------------------------------------------------------------------
! End and clean up gas transmission function calculation
!--------------------------------------------------------------------
...
!    kbegin     Index of the starting and ending vertical levels
!    pd, plm, pa Presure coordinate variables, at boundaries, mid points
!
!-------------------------------------------------------------------
...
!--------------------------------------------------------------------
! Subroutine to process ch4 file information
!--------------------------------------------------------------------
...
!    pd, plm, pa   pressure coordinate variables, at boundaries, mid pointsxs
!
!-------------------------------------------------------------------
...
!--------------------------------------------------------------------
! Subroutine to analytically calculate temperature profiles of atmosphere
! with arbitrary levels
!--------------------------------------------------------------------
real, intent(in)   ::  z
...
!
!    gas_name   name of the gas specy
!    gas_amount name of the gas specy
!    nstdlvls   number of standard levels
!    kbegin, kend index of the starting and ending vertical levels
!    pd, plm, pa  pressure coordinate variable, at boundaries, mid points
!
!--------------------------------------------------------------------
