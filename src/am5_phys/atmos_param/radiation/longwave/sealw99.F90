...
logical            ::   &
           do_nlte = .false.        ! there is a non-local thermodynamic
                                    ...
                                    ! of model ?
character(len=16)  ::  &
            continuum_form = 'mt_ckd2.5' ! continuum specification; either
                                         ! 'ckd2.1', 'ckd2.4', 'mt_ckd2.5', 
                                         ! 'rsb', 'bps2.0' or 'none'
character(len=16)  ::  &
        linecatalog_form = 'hitran_2012' ! line catalog specification; either
                                         ! 'hitran_1992' or 'hitran_2000' or 'hitran_2012'
integer            ::  &
        verbose = 5                 ! verbosity level, ranges from 0
...
!    temp, tflux
!    rh2o, deltaz, qo3
!    rrvco2, rrvf11, rrvf12, rrvf113, rrvf22 radiative gases 
...
!---------------------------------------------------------------------
! subroutine to calculate the cool to space approximation longwave radiation
!---------------------------------------------------------------------
...
!  intent(inout) variables:
!
!     Lw_diagnostics  longwave diagnotics output
!
!  intent(in),optional:
...
!     gxctscf   the "exact" surface flux accumulated over the frequency bands in the 160-1200 cm-1 range
!
!--------------------------------------------------------------------
...
!      cldtf    cloud transmission function
...
!
!      e1ctw1 cool to space thermal exchange in 0-560 band
!      e1ctw2 cool to space thermal exchange in 1200-2200 band
!      trans_band1 transmission functions in band 1
!      trans_band2 transmission functions in band 2
...
!       tch4n2oe CH3 and N2O transmission function
!
!   intent(inout) variables:
!
!       trans_band1  transmission function in band 0-560
!       trans_band2  transmission function in band 1200-2200
