...
! CONTACT - Fei.Liu@noaa.gov - Fei Liu
! REVIEWER - ds@gfdl.noaa.gv - Dan Schwarzkopf
!
...
use longwave_utilities_mod, only: longwave_tables1_type,  &
                                  longwave_tables2_type,  &
                                  longwave_tables3_type,  &
                                  lw_table_type, Sealw99_control,  &
                                  table_alloc, mass_1, temp_1

use longwave_params_mod,    only: NBLW, NBLX, NBLY_RSB, NBLY_CKD
...
!#####################################################################
subroutine longwave_tables_init (NBTRG_in, NBTRGE_in, OFFSET_in, &
                                 Lw_tables, tabsr, tab1, tab2, tab3, &
...
integer,                      intent(in)    :: NBTRG_in, NBTRGE_in, &
                                               OFFSET_in
...
!
!    Lw_tables  contains the tables used in long wave radiation
!    tabsr " "
!    tab1  " "
!    tab2  " "
!    tab3  " "
